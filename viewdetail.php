...
<html>
    ...
    <title>Kampung Bundong</title>
        ...
        <link rel="stylesheet" href="detail">
...
<body>
  ...
  <a href="search.php">Search</a>
             <b style="float:right"><a href="index.php">Log Out</a></b>
...
<?php endif ?>
    ...
    $results = mysqli_query($con,$a); 
        if ($row = mysqli_fetch_assoc($results)) { ?>
             ...
             <h2>TARIKH KHAWIN (tahun/bulan/hari)</h2><?php echo $row['tarikh']; ?>
	...
	<thead>
        ...
        <th>Tiada</th><td><?php echo $row['tiada']; ?></td>	
             ...
             <a href="edit.php" class="del_btn"><button>EDIT</button></a>
<a href="delete.php?del=<?php echo $row['mykad']; ?>" class="del_btn"><button>Delete</button> </a>
             	<?php }} ?>
        </div>
    </div>
